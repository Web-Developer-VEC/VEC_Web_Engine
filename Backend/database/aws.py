...
def insert_staff_data_sections():
    base_path = "/root/VEC_Web_Engine/Backend/docs/STAFF_DATA/"  # 👈 your staff folder path
...
def insert_iic_sections():
    ...
    with open("/root/VEC_Web_Engine/Backend/docs/iic.json", "r", encoding="utf-8") as file:
...
def insert_admissions_sections():
    ...
    with open("/root/VEC_Web_Engine/Backend/docs/admissions.json", "r", encoding="utf-8") as file:
...
def insert_exams_sections():
    ...
    with open("/root/VEC_Web_Engine/Backend/docs/exams.json", "r", encoding="utf-8") as file:
        exams_data = json.load(file)
...
def insert_placement_sections():
    ...
    with open("/root/VEC_Web_Engine/Backend/docs/placement.json", "r", encoding="utf-8") as file:
        exams_data = json.load(file)
...
def insert_iqac_sections():
    ...
    with open("/root/VEC_Web_Engine/Backend/docs/IQAC.json", "r", encoding="utf-8") as file:
        exams_data = json.load(file)
...
def insert_accreditations_and_ranking_sections():
    ...
    with open("/root/VEC_Web_Engine/Backend/docs/accreditations_and_ranking.json", "r", encoding="utf-8") as file:
        exams_data = json.load(file)
...
def insert_ecell_sections():
    ...
    with open("/root/VEC_Web_Engine/Backend/docs/e_cell.json", "r", encoding="utf-8") as file:
        exams_data = json.load(file)
...
def insert_transport_sections():
    ...
    with open("/root/VEC_Web_Engine/Backend/docs/transport.json", "r", encoding="utf-8") as file:
        exams_data = json.load(file)
...
def insert_other_facilities_sections():
    ...
    with open("/root/VEC_Web_Engine/Backend/docs/other_facilities.json", "r", encoding="utf-8") as file:
        exams_data = json.load(file)
...
def insert_gallery_sections():
    ...
    with open("/root/VEC_Web_Engine/Backend/docs/gallery.json", "r", encoding="utf-8") as file:
        exams_data = json.load(file)
...
def insert_academics_sections():
    ...
    with open("/root/VEC_Web_Engine/Backend/docs/academics.json", "r", encoding="utf-8") as file:
        exams_data = json.load(file)
...
def insert_incubations_sections():
    ...
    with open("/root/VEC_Web_Engine/Backend/docs/incubation.json", "r", encoding="utf-8") as file:
        exams_data = json.load(file)
...
def insert_about_us():
    ...
    with open("/root/VEC_Web_Engine/Backend/docs/about_us.json", "r", encoding="utf-8") as file:
...
def insert_administration_sections():
    ...
    with open("/root/VEC_Web_Engine/Backend/docs/administration.json", "r", encoding="utf-8") as file:
...
def insert_web_team():
    ...
    with open('/root/VEC_Web_Engine/Backend/docs/web_team.json', "r",encoding="utf-8") as file:
        documents = json.load(file)
    collection.insert_many(documents)
...
def insert_hostel_sections():
    ...
    with open("/root/VEC_Web_Engine/Backend/docs/hostel.json", "r", encoding="utf-8") as file:
        exams_data = json.load(file)
...
def insert_ncc_army_sections():
    ...
    with open("/root/VEC_Web_Engine/Backend/docs/ncc_army.json", "r", encoding="utf-8") as file:
        exams_data = json.load(file)
...
def insert_ncc_navy_sections():
    ...
    with open("/root/VEC_Web_Engine/Backend/docs/ncc_navy.json", "r", encoding="utf-8") as file:
        exams_data = json.load(file)
...
def insert_nss_sections():
    ...
    with open("/root/VEC_Web_Engine/Backend/docs/nss.json", "r", encoding="utf-8") as file:
        exams_data = json.load(file)
...
def insert_sports_sections():
    ...
    with open("/root/VEC_Web_Engine/Backend/docs/sports_data.json", "r", encoding="utf-8") as file:
        exams_data = json.load(file)
...
def insert_yrc_sections():
    ...
    with open("/root/VEC_Web_Engine/Backend/docs/yrc.json", "r", encoding="utf-8") as file:
        exams_data = json.load(file)
...
def insert_landing_page_sections():
    ...
    with open("/root/VEC_Web_Engine/Backend/docs/landing_page_details.json", "r", encoding="utf-8") as file:
        exams_data = json.load(file)
...
def insert_research_data():
    ...
    with open('/root/VEC_Web_Engine/Backend/docs/research.json', "r",encoding="utf-8") as file:
        documents = json.load(file)
    collection.insert_many(documents)
...
'''def add_hostel_student_database():
    ...
    storage_dir = r"/root/VEC_Web_Engine/Backend/docs/CSV"
    image_dir = r"/root/VEC_Web_Engine/Backend/static/student_database"
