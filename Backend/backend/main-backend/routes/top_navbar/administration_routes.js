...
const allowedtypes = require('../../models/top_navbar/administration_models');
...
router.post('/administration', limiter, xss, nosql,hitTracker,  general_controller(allowedtypes,'administration'));
