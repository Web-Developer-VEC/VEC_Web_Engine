...
const allowedtypes = require("../../models/top_navbar/admission_models");
...
router.post('/admission', limiter, xss, nosql, hitTracker, general_controller(allowedtypes,'admissions'));
