...
const allowedtypes = require('../../models/top_navbar/research_models');
...
router.post('/research', limiter, xss, nosql, hitTracker, general_controller(allowedtypes,'research'));
