...
const allowedtypes = require('../../models/second_navbar/ncc_army_models')
...
router.post('/ncc_army', limiter, xss, nosql, hitTracker, general_controller(allowedtypes,'ncc_army'));
