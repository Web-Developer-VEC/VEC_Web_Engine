...
const allowedtypes = require('../../models/second_navbar/transport_models') ;
...
router.post('/transport', limiter, xss,nosql, hitTracker,  general_controller(allowedtypes,'transport'));
