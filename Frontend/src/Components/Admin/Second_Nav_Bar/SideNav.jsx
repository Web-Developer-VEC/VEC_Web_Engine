...
const SideNav = ({ sts, setSts, navData, cls, backButton = false }) => {
    ...
    return (
        <div className={cls + " grid w-screen grid-cols-10 mt-0 *:px-2"}>
            <nav className="bg-black pt-4 pb-12 flex gap-y-2 gap-x-2 flex-wrap
    lg:grid text-md min-h-fit content-start col-start-0 col-span-10 lg:col-span-2
    transition-all duration-300 ease-in-out overflow-visible">
            ...
            <div className="col-span-10 lg:col-span-8 overflow-x-hidden overflow-y-visible">
