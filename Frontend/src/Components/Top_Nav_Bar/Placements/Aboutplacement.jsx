...
/>
    ...
    <div className="AP-main-container">
      ...
      <section className="AP-vision-mission">
        <div className="AP-grid">
          <div className="AP-grid-item">
            <div className="AP-card dark:bg-[color-mix(in_srgb,theme(colors.drkp)_95%,white)]">
              <h2 className="AP-card-title text-secd dark:text-drks">Our Vision</h2>
          ...
          <div className="AP-grid-item">
            <div className="AP-card dark:bg-[color-mix(in_srgb,theme(colors.drkp)_95%,white)]">
              <h2 className="AP-card-title text-secd dark:text-drks">Our Mission</h2>
      ...
      {/* About Section */}
      <section className="AP-about-section dark:bg-[color-mix(in_srgb,theme(colors.drkp)_95%,white)]">
        <div className="AP-about-content">
          <div className="AP-about-text">
            <h2 className="AP-about-title text-secd dark:text-drks">Training & Placement Department</h2>
      ...
      {/* Contact Section */}
      <section className="AP-contact-section dark:bg-[color-mix(in_srgb,theme(colors.drkp)_95%,white)]">
        <div className="AP-contact-wrapper">
          <div className="AP-contact-header">
            <h2 className="text-secd dark:text-drks">Contact Placement Cell</h2>
          </div>
          <div className="AP-contact-details">
            <div className="AP-contact-info">
              <h3 className="AP-contact-name text-secd dark:text-drks">Arun Ramaswami A</h3>
