  ...
  return (
    <>
      ...
      <div className="research-academicresearch-container">
        <h1 className="research-academicresearch-title text-secd dark:text-drks">
          ...
          {years.map((year) => (
            <button
              ...
              className={`research-academicresearch-button dark:text-drkt ${
        ...
        <iframe
          src={pdfUrl}
          className="research-academicresearch-iframe-container [border:0.25rem_solid_theme(colors.secd)]
