        ...
        <div className="Management bg-prim dark:bg-drkp">
            <div className="Founder text-text dark:text-drkt
                ...
                <p>As Founder - Chairman of the Velammal group of institutions, it is indeed a unique privilege for me to communicate to you utilizing our college website.
                    ...
                    In fact, our mission is very clearly reflected in our vision, viz<br></br>

                    <b className="text-accn dark:text-drka">“TO EDUCATE THE STUDENT COMMUNITY BOTH BY THEORY AND PRACTICE TO FIT IN WITH SOCIETY AND TO CONQUER TOMORROW'S TECHNOLOGY AT GLOBAL LEVEL WITH HUMAN VALUES THROUGH OUR DEDICATED TEAM.”</b><br />
                    ...
                    Let me once again welcome you into our fold and hope you will also utilize this prized opportunity to its fullest extent to finally emerge as one of the brightest stars on the horizon of success. Wishing you all the best and hope you have a pleasant and memorable tenure in our midst
                </p>
            </div>
            <div className="Chairman
                bg-[color-mix(in_srgb,theme(colors.prim)_90%,black)]
                dark:bg-[color-mix(in_srgb,theme(colors.drkp)_95%,white)]">
                <img src="/Images/Ceo.jpg" alt="Ceo's Image" />
                <h2>CEO'S Message</h2>
