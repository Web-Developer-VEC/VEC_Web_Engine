...
/>
      ...
      <div className="bg-gray-100 min-h-screen">
        ...
        <div className="mt-12 container1 mx-auto px-6">
        <motion.div
              ...
              className="text-left"
            >
              <h2 className="text-3xl font-bold text-gray-800 mb-4 border-b-4 border-amber-500 inline-block pb-2">
...
A very humble, rustic lady with rural background and an unassuming attitude was how one described Smt. Velammal when they met her for the first time. But this frail lady, with her conviction and determination inspired the society and transformed it through her devoted son, Shri M.V.Muthuramalingam.
        ...
        <div className="mt-16 bg-white py-12 px-6 rounded-t-3xl shadow-lg">
          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8">
            {managementTeam.map((person, index) => (
              ...
              >
                ...
                <h6 className="text-sm text-amber-500">{person.role}</h6>
                <p className="mt-2 text-gray-600">Velammal Educational Trust</p>
              </motion.div>
            ))}
          </div>
        </div>
