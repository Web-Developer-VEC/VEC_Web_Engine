    ...
    return (
        <article className="flex flex-wrap gap-y-4 bg-gray-100 shadow-xl p-6 rounded-xl">
          <div className="basis-full md:basis-1/5">
            ...
            <h2 className="text-xl">Dr.S.Rajendraprasath , B.Sc., M.A., M.L.I.Sc., M.phil., Ph.D</h2>
            <p className="text-lg text-accn">Librarian and Head, Department of Library and Information Science</p>
          </div>
          <p className="grow basis-4/5 tracking-wide text-2xl px-4 italic">"VEC’s Central Library is a one of it’s kind installation that facilitates teaching, learning and research endeavours  of  our  students,  scholars  and  faculty  members.  It  is  one  of  the  formost  such  libraries  in  Tamil Nadu    higher  educational  systems.    significant  efforts  are  not  just  building  structure  that  stores  books.    It serves  more  realistically  as  a  space  for  learning  and  knowledge  exchange  with  users  coming  from  diverse study and aspirational backgrounds."</p>
        </article>
    )
  }
