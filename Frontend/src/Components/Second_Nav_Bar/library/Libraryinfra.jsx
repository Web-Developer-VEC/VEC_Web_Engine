    ...
    return (
        <>
            <div className="min-h-screen p-3 md:p-6 lg:p-10 space-y-8 md:space-y-12 lg:space-y-16">
                <div className="max-w-7xl mx-auto flex flex-wrap gap-4 justify-center">
                    {sections.map((section, index) => (
                        <motion.div
                            key={index}
                            className="flex flex-col rounded-xl shadow-md overflow-hidden cursor-pointer transform
                            ...
                            <div className="p-4 sm:p-5 space-y-3 sm:space-y-5">
                                <h2 className="text-xl sm:text-2xl font-semibold text-accn dark:text-drks">{section.title}</h2>
                ...
                {/* Additional Sections */}
                <div
                    className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 md:gap-10">
                    {additionalSections.map((section, index) => (
                        <motion.div
                            key={index}
                            className="p-4 sm:p-6 md:p-8 rounded-2xl shadow-md sm:shadow-lg text-center
                                bg-[color-mix(in_srgb,theme(colors.prim)_85%,black)]
                                dark:bg-[color-mix(in_srgb,theme(colors.drkp)_95%,white)]
                                transition duration-500 hover:scale-105 hover:shadow-2xl
                                hover:bg-[color-mix(in_srgb,theme(colors.secd),transparent_85%)]
                                dark:hover:bg-[color-mix(in_srgb,theme(colors.drks),transparent_85%)]"
                            initial={{opacity: 0, y: 50}}
                            whileInView={{opacity: 1, y: 0}}
                            transition={{duration: 0.8}}
                            viewport={{once: true}}>
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-accn dark:text-drks mb-4
                                sm:mb-6">{section.category}</h2>
                            <ul className="space-y-2 sm:space-y-3 text-sm sm:text-base md:text-lg">
                                {section.items.map((item, i) => (
                                    <motion.li
                                        key={i}
                                        className="flex items-center space-x-2 sm:space-x-3 hover:text-accn
                                            dark:hover:text-drks transition-colors duration-300"
                                        initial={{opacity: 0, x: -20}}
                                        whileInView={{opacity: 1, x: 0}}
                                        transition={{delay: i * 0.1}}
                                        viewport={{once: true}}>
                                        <span className="w-2 h-2 sm:w-3 sm:h-3 bg-secd dark:bg-drks rounded-full" />
            ...
            <div className="min-h-screen py-10 px-4 sm:px-6 flex flex-col items-center">
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-accn dark:text-drks mb-6 sm:mb-10">
                ...
                <div className="max-w-5xl w-full grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 md:gap-8">
                    {generalInstructions.map((instruction, index) => (
                        <motion.div
                            key={index}
                            className="relative bg-[color-mix(in_srgb,theme(colors.prim)_85%,black)]
                                dark:bg-[color-mix(in_srgb,theme(colors.drkp)_95%,white)]
                            ...
                            <div className="flex items-center space-x-3 sm:space-x-4">
                              <span className="w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center
                                bg-secd text-text dark:bg-drks dark:text-drkt font-bold rounded-full text-sm
                                sm:text-lg transition-transform duration-500">{index + 1}</span>
            ...
            <div className="mx-auto w-full p-4 sm:p-6">
                <h2 className="text-2xl sm:text-3xl font-bold text-center text-accn dark:text-drks mb-4 sm:mb-6">
                    MEMBERSHIP DETAILS
                </h2>
                <motion.div
                    ...
                    <div className="w-full overflow-x-auto">
                        <div className="min-w-[750px] inline-block">
                            <table className="w-full border-collapse backdrop-blur-lg shadow-xl">
                                <thead>
                                <tr className="bg-secd text-text dark:bg-drks dark:text-white text-sm sm:text-base">
            ...
            <div className="max-w-6xl mx-auto p-6 flex flex-col lg:flex-row items-center gap-12">
                ...
                <motion.div
                    ...
                    transition={{duration: 0.8}}
                    viewport={{once: true}}>
                    <h2 className="text-3xl font-bold text-accn dark:text-drks">BORROWING AND CIRCULATION</h2>
                    <p className="text-lg">
                        ...
                        availability of books, CDs, journals, and reservation of books are made in the circulation
                        section.
                    </p>
                </motion.div>
            </div>
            ...
            <div className="min-h-screen py-12 sm:py-16 px-4 sm:px-6 space-y-12 sm:space-y-16">
                <h2 className="text-3xl sm:text-4xl font-extrabold text-center text-accn dark:text-drks
                ...
                <div className="max-w-6xl mx-auto space-y-12">
                    {librarySections.map((section, index) => (
                        <motion.div
                            ...
                            {/* Image Section */}
                            <motion.div
                                className="w-1/2 hidden md:block h-full overflow-hidden rounded-3xl shadow-lg"
                            ...
                            <div className="w-full md:w-1/2 h-full p-6 backdrop-blur-lg rounded-2xl shadow-lg
                                ...
                                <h3 className="text-2xl sm:text-3xl font-bold text-accn dark:text-drks">{section.title}</h3>
            ...
            <div className="min-h-screen py-12 sm:py-16 px-4 sm:px-6">
                <h2 className="text-3xl sm:text-5xl font-extrabold text-center text-accn dark:text-drks uppercase tracking-wide mb-8 sm:mb-12">
                    Library Highlights
                </h2>
           ...
           group-hover:shadow-2xl"
                            >
                                ...
                                <div className="p-5 sm:p-6">
                                    <h3 className="text-xl sm:text-2xl font-bold text-accn dark:text-drks
              group-hover:text-accn dark:group-hover:text-drka transition-colors">
                                        {section.title}
                                    </h3>
            ...
            <div className="min-h-screen py-16 px-6">
                <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        <h2 className="text-4xl font-bold text-accn dark:text-drks mb-6">
                            MULTIMEDIA LIBRARY
                        </h2>
            ...
            <div className="min-h-screen py-16 px-6">
                <h2 className="text-4xl font-bold text-accn dark:text-drks mb-12 text-center">
                    NEW ARRIVALS
                </h2>
               ...
               hover:scale-105"
                        ...
                        >
                            ...
                            <div className="p-6 text-center">
                                ...
                                <p className="text-accn dark:text-drks font-semibold mt-2">{faculty.role}</p>
                            </div>
                        </motion.div>
                    ))}
                </div>
                            ...
                            {openSection === index && (
                                ...
                                >
                                    {Array.isArray(section.content) ? (
                                        <ul className="list-disc marker:text-secd dark:marker:text-drks pl-6 space-y-2">
                                            {section.content.map((item, idx) =>
                                                typeof item === "string" ? (
                                                    ...
                                                    <li key={idx}>
                                                        <a href={item.link}
                                                           className="text-accn dark:text-drks hover:underline"
