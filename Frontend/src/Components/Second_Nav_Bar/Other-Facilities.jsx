...
const facilities = [
  ...
  { 
    name: "Seminar Hall", 
    img_name: ["Seminar Hall","Vivekananda Hall","Placement Seminar Hall","Placement Seminar Hall"," Billgate Seminar Hall "],
    ...
    images: ["/static/images/other_facilities/Seminar Halls/Vivehananda Seminar Hall.webp"]
  },
  { 
    name: "On-Campus Medical Facility ", 
    img_name: ["VEC Medical Doctor", "VEC Medical Bed", "VEC Medical Bed", "Medicine", "Wheel Chair", "Ambulance"],
    ...
    images: ["/static/images/other_facilities/Health Centre/HC 1.webp","/static/images/other_facilities/Health Centre/HC 2.webp","/static/images/other_facilities/Health Centre/HC 3.webp","/static/images/other_facilities/Health Centre/HC 4.webp","/static/images/other_facilities/Health Centre/HC 5.webp","/static/images/other_facilities/Health Centre/HC 6.webp"]
  },
  { 
    name: "Reprographic facility ", 
    img_name: ["Reprographic facility 1", "Reprographic facility 2", "Reprographic facility 3", "Reprographic facility 4", "Reprographic facility 5", "Reprographic facility 6"],
    ...
    images: ["/static/images/other_facilities/Repographic Facility/RF 1.webp","/static/images/other_facilities/Repographic Facility/RF 2.webp","/static/images/other_facilities/Repographic Facility/RF 3.webp","/static/images/other_facilities/Repographic Facility/RF 4.webp","/static/images/other_facilities/Repographic Facility/Repographic 1.webp","/static/images/other_facilities/Repographic Facility/Repographic 2.webp"]
  },
  { 
    name: "Store", 
    img_name: ["Store 1", " Store 2"],
  ...
  { 
    ...
    img_name: ["Sewage Treatment Plant"],
    ...
    images: ["/static/images/other_facilities/Sewage Plant/Sweage Plant 1.webp","/static/images/other_facilities/Sewage Plant/Sweage Plant 2.webp","/static/images/other_facilities/Sewage Plant/","/static/images/other_facilities/Sewage Plant/Sweage Plant.webp"]
  },
  { 
    name: "RO (Reverse Osmosis)", 
    img_name: ["RO (Reverse Osmosis)"],
  ...
  { 
    ...
    img_name: ["Student Counseling Services"],
  ...
  { 
    ...
    img_name: ["High-Speed Internet Facility"],
    ...
    images: ["/static/images/other_facilities/High Speed Internet Facility/Airtel 1.webp","/static/images/other_facilities/High Speed Internet Facility/Airtel 2.webp","/static/images/other_facilities/High Speed Internet Facility/BSNL.webp","/static/images/other_facilities/High Speed Internet Facility/NIA .webp","/static/images/other_facilities/High Speed Internet Facility/Tata.webp"]
  },
  { 
  ...
  { 
    ...
    img_name: ["Faculty Accommodation"],
    ...
    images: ["/static/images/other_facilities/Faculty Accomodation/Faculty Accomodation.webp","/static/images/other_facilities/Faculty Accomodation/Faculty Accomodation 1.webp"]
  },
  { 
    name: "Spacious Food Canteen", 
    img_name: ["Spacious Food Cantee"],
  ...
  { 
    ...
    img_name: ["Surveillance & Security"],
  ...
  return (
    ...
    <div className="facilities-container">
      ...
      <div className="content-container">
        <h2 className="current-facility">{currentFacility.name}</h2>
