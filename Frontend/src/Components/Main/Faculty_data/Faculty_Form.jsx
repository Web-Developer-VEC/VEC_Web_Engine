...
const Faculty_Form = () => {
  ...
  const [mediaLinkplaceholder , setMediaLinkplaceholder] = useState({
...
const [conferenceCollections, setConferenceCollections] = useState([
  ...
  const [detailsCounts, setDetailsCounts] = useState(
  {
    ...
    bookOrBookChapterPublished: null,
    seminarDelivered: null,
    seminarAttended: null,
    conferenceOrganized: null,
    phdProduced: null,
    phdPursuing:null,
     },
   );
...
const handlePatents = (index, key, value) => {
  if(key === "patentRecentAchieved" && value.length >4){
...
const handleInputChange = (degreeIndex, qualIndex, field, value) => {
  ...
  const handleFacCounts = (key,value) => {
     setDetailsCounts((prev)=>(
      {
        ...prev , [key]:value
      }
     ))
...
const handleGeneralInfoChange = (key, value,blur) => {
  if (key === "mail_id" && blur) {   // ✅ fix typo here
    const vecEmailFormat = /^[\w.-]+@velammal\.edu\.in$/;
    const facEmailValidation = vecEmailFormat.test(value);

    if (facEmailValidation) {
      setGeneralInformation(value); // ✅ store the actual email, not the old state
    } else {
      alert("Enter a valid Velammal E-mail");
      value=""
    }
  }
...
const facultyFormSubmited = async (e) => {
  ...
  const { photo, ...restGeneralInfo } = generalInformation;

  const formData = new FormData();

  formData.append("general_information", JSON.stringify(restGeneralInfo));
  formData.append("socialmedia_links", JSON.stringify(mediaLink));
  formData.append("counts", JSON.stringify(detailsCounts));
  formData.append("educational_qualification", JSON.stringify(educationData));
  formData.append("conference_publications", JSON.stringify(conferenceCollections));
  formData.append("experience", JSON.stringify(experienceCollections));
  formData.append("book_publications", JSON.stringify(bookPubCollections));
  formData.append("patents", JSON.stringify(patentCollections));
  formData.append("projects", JSON.stringify(projectCollections));
  formData.append("journal_publications_list", JSON.stringify(journalCollections));
  formData.append("research_scholars", JSON.stringify(researchCollections));

 if(!photo){
  alert("Upload image befor submitting form")
 }
  if (photo) {
  ...
  try{
    const response = await fetch("/api/admin-backend/facultydetails",{
      method: "POST",
      credentials: "include",
      body: formData, 
    })
  ...
  return (
    <>
      <h1 className="page-title">Faculty Form Details</h1>
      <form className="Form-container" onSubmit={facultyFormSubmited}>
        ...
        <div className=" Basic-detail">
            ...
            <div className="fac-namesession">
                <div className="fac-namedetails">
                  ...
                  <select 
                    ...
                    required
                  >
                    <option value="" disabled selected hidden>--- E.g : Dr , Mr , Mrs ---</option>
            ...
            />
              ...
              <input id="email" type="email" placeholder="E.g : ajith@velammal.edu.in" value={generalInformation.mail_id}  onChange={(e) => handleGeneralInfoChange("mail_id", e.target.value.toLowerCase())} required   autoComplete="new-password"  onPaste={(e)=>e.preventDefault()} onBlur={(e)=>handleGeneralInfoChange("mail_id",e.target.value.toLowerCase(),true)} />
              </div>
            </div>
        </div>
        </div>
        ...
        <div className="form-group">
          <label htmlFor="googleScholar">Google Scholar</label>
            ...
            <input
              id="googleScholar"
              type="text"
              placeholder={`E.g :${mediaLinkplaceholder.scholarprefix}`}
          ...
          <div className="form-group">
            ...
            <input id="researchGate" type="text"  placeholder={`E.g: ${mediaLinkplaceholder.researchprefix}`}
            onChange={((e)=>(handleLinkChange("researchprefix",e.target.value)))}/>
          </div>
          <div className="form-group">
            <label htmlFor="orchidProfile">Orchid Profile</label>
            <input id="orchidProfile" type="text"  placeholder={`E.g :${mediaLinkplaceholder.orchidprefix}`}
             onChange={((e)=>(handleLinkChange("orchidprefix",e.target.value)))}/>
          </div>
          <div className="form-group">
            <label htmlFor="publonProfile">Publon Profile</label>
            <input id="publonProfile" type="text"  placeholder={`E.g :${mediaLinkplaceholder.publonprefix}`}
             onChange={((e)=>(handleLinkChange("publonprefix",e.target.value)))}/>
          </div>
          <div className="form-group">
            <label htmlFor="scopus">Scopus</label>
            <input id="scopus" type="text"  placeholder={`E.g :${mediaLinkplaceholder.scopusprefix}`}
             onChange={((e)=>(handleLinkChange("scopusprefix",e.target.value)))} />
          </div>
          <div className="form-group">
            <label htmlFor="linkedin">LinkedIn</label>
            <input id="linkedin" type="text"  placeholder={`E.g :${mediaLinkplaceholder.linkedinprefix}`}
          ...
          <div
            ...
            <div className="form-group">
              ...
              <input
                id={`bookName-${index}`}
                type="text"
              placeholder="E g: AI in Education, 2nd Edition "
  ...
  {patentCollections.map((patentData, index) => (
    ...
    >
      <div className="form-group">
        ...
        <input
          id={`patentName-${index}`}
          type="text"
        placeholder="E g: AI-based Learning System"
          ...
          <div
            ...
            <div className="form-group">
              <label htmlFor={`sanction-${index}`}>
                year of Sanction <span style={{ color: "red", fontSize: "20px" }}>*</span>
              </label>
              <input
                id={`sanction-${index}`}
                type="number"
            ...
            <div className="form-group">
              ...
              <input
                id={`status-${index}`}
                type="text"
               placeholder="E.g: Ongoing or Published"
   ...
   <fieldset className="tile">
        ...
        <div>
          ...
          >
            <div className="form-group">
              ...
              <input
                type="text"
               placeholder="Deepak Kumar, Ramesh S"
            ...
            <div className="form-group">
              ...
              <input
                ...
                placeholder="AI for Smart Education"
                onChange={(e) =>
            ...
            <div className="form-group">
              ...
              <input
                ...
                placeholder="International Journal of AI Research"
                onChange={(e) =>
        ...
        <div
          ...
          <div className="form-group">
            ...
            <input
              ...
              type="text"
              // required
              placeholder="Deep Learning in Healthcare"
        ...
        >
          ...
          <div className="form-group">
            ...
            <input
              ...
              type="text"
              placeholder="E g : International Conference on ABC"
              // required
    ...
    <fieldset className="tile">
      <div className="flex flex-col  justify-between  "><h2>Counts</h2><small style={{color:"red",fontSize:"18px",fontWeight:"400",padding:"0 0 0rem 0",marginLeft:"1rem",marginTop:"1rem"}}>* Note: If you do not have any counts, please enter zero</small></div>

        <div>
            <div className="two-column border-4 p-3 m-2 rounded-md" >
            <div className="form-group">
              <label htmlFor="profMemCount">Professional Membership  <span style={{color:"red" , fontSize: "18px",fontWeight:"lighter"}}>* </span></label>
              <input
              id="profMemCount"
              type="number"
              min={0} 
              ...
              onChange={(e)=>(handleFacCounts("professionalMembership",e.target.value))}
               />
            </div>
            <div className="form-group">
              <label htmlFor="sponsorPrjCount">Sponsored Projects</label>
              <input
              id="sponsorPrjCount"
              type="number"
              min={0} 
              ...
              onChange={(e)=>(handleFacCounts("sponsoredProjects",e.target.value))}
               />
            </div>
            <div className="form-group">
              <label htmlFor="patentGrantedCount">Patent Granted</label>
              <input
              id="patentGrantedCount"
              type="number"
              min={0} 
              placeholder=" E.g:5"
              required 
              ...
              onChange={(e)=>(handleFacCounts("patentGranted",e.target.value))}
               />
            </div>
            <div className="form-group">
              <label htmlFor="patentPublishedCount">Patent Published</label>
              <input
              id="patentPublishedCount"
              type="number"
              min={0} 
              placeholder=" E.g: 5"
              required 
              ...
              onChange={(e)=>(handleFacCounts("patentPublished",e.target.value))}
               />
            </div>
            <div className="form-group">
              <label htmlFor="patentFiledCount">Patent Filed</label>
              <input
              id="patentFiledCount"
              type="number"
              min={0} 
              ...
              onChange={(e)=>(handleFacCounts("patentFiled",e.target.value))}
               />
            </div>
            <div className="form-group">
              <label htmlFor="journalPublicationsCount"> Journal Publications</label>
              <input
              id="journalPublicationsCount"
              type="number"
              min={0} 
              placeholder=" E.g: 5"
              required 
              ...
              onChange={(e)=>(handleFacCounts("journalPublications",e.target.value))}
              />
            </div>
            <div className="form-group">
              <label htmlFor="conferencePublicationsCount">Conference Publications</label>
              <input
              id="conferencePublicationsCount"
              type="number"
              min={0} 
              placeholder=" E.g: 5"
              required 
              ...
              onChange={(e)=>(handleFacCounts("conferencePublications",e.target.value))}
               />
            </div>
            <div className="form-group">
              <label htmlFor="bookOrBookChapterPublishedCount">Book/Book Chapter Published</label>
              <input
              id="bookOrBookChapterPublishedCount"
              type="number"
              min={0} 
              placeholder=" E.g: 5"
              required 
              ...
              onChange={(e)=>(handleFacCounts("bookOrBookChapterPublished",e.target.value))}
              />
            </div>
            <div className="form-group">
              <label htmlFor="seminarDeliveredCount">Seminar Delivered</label>
              <input
              id="seminarDeliveredCount"
              type="number"
              min={0} 
              placeholder=" E.g: 5"
              required 
              ...
              onChange={(e)=>(handleFacCounts("seminarDelivered",e.target.value))}
              />
            </div>
            <div className="form-group">
              <label htmlFor="seminarAttendedCount">Seminar Attended</label>
              <input
              id="seminarAttendedCount"
              type="number"
              min={0} 
              placeholder=" E.g: 5"
              required 
              ...
              onChange={(e)=>(handleFacCounts("seminarAttended",e.target.value))}
              />
            </div>
            <div className="form-group">
              <label htmlFor="conferenceOrganizedCount">Conference Organized</label>
              <input
              id="conferenceOrganizedCount"
              type="number"
              min={0} 
              placeholder=" E.g: 5"
              required 
              ...
              onChange={(e)=>(handleFacCounts("conferenceOrganized",e.target.value))}
              />
            </div>
            <div className="form-group">
              <label htmlFor="phdProducedCount">PHD Produced</label>
              <input
              id="phdProducedCount"
              type="number"
              min={0} 
              ...
              onChange={(e)=>(handleFacCounts("phdProduced",e.target.value))}
              />
            </div>
            <div className="form-group">
              <label htmlFor="phdPursuingCount">PHD Pursuing</label>
              <input
              id="phdPursuingCount"
              type="number"
              min={0} 
              ...
              onChange={(e)=>(handleFacCounts("phdPursuing",e.target.value))}
              />
            </div>
            </div>
