            ...
            <div className="form-input form-grid grid-sdp-row" key={rowIndex}>
              ...
              >
                <input
                  type="file"
                  ref={(el) =>
                    (fileRefs.current[`student_development_parameters_${key}`] =
                      el)
                  }
                  style={{ display: "none" }}
                  onChange={(e) =>
                ...
                <button
                  type="button"
                  onClick={() =>
                    handleUploadClick(`student_development_parameters_${key}`)
                  }
                >
                  Upload
                </button>
          ...
          <div className="form-input form-grid grid-6" key={index}>
            ...
            <div style={{ display: "flex", gap: "4px", alignItems: "center" }}>
              <input
                type="file"
                ref={(el) =>
                  (fileRefs.current[`professional_associations_${key}`] = el)
                }
                style={{ display: "none" }}
                onChange={(e) =>
                  handleFileChange(
              ...
              <Eye
                style={{ cursor: "pointer" }}
                onClick={() =>
                  viewFile(page3Data.professional_associations[key].pdf_path)
                }
              />
              <button
                type="button"
                onClick={() =>
                  handleUploadClick(`professional_associations_${key}`)
                }
              >
                Upload
              </button>
            ...
            <div className="form-input form-grid grid-6" key={index}>
              ...
              >
                <input
                  type="file"
                  ref={(el) =>
                    (fileRefs.current[`competitions_participated_won_${key}`] =
                      el)
                  }
                  style={{ display: "none" }}
                  onChange={(e) =>
                ...
                <button
                  type="button"
                  onClick={() =>
                    handleUploadClick(`competitions_participated_won_${key}`)
                  }
                >
                  Upload
                </button>
          ...
          <div className="form-input form-grid grid-6" key={index}>
            ...
            <div style={{ display: "flex", gap: "4px", alignItems: "center" }}>
              <input
                type="file"
                ref={(el) =>
                  (fileRefs.current[`mou_centre_of_excellence_${key}`] = el)
                }
                style={{ display: "none" }}
                onChange={(e) =>
                  handleFileChange(
              ...
              <Eye
                style={{ cursor: "pointer" }}
                onClick={() =>
                  viewFile(page3Data.mou_centre_of_excellence[key].pdf_path)
                }
              />
              <button
                type="button"
                onClick={() =>
                  handleUploadClick(`mou_centre_of_excellence_${key}`)
                }
              >
                Upload
              </button>
...
<div className="section">
  ...
  {/* ===== DATA ROWS ===== */}
  {Object.keys(
    page3Data.placements_higher_studies_entrepreneurship
  ).map((key, index) => {
    const row =
      ...
      <div className="naac-grid data-row" key={index}>
        ...
        <div className="upload-cell">
          <input
            ...
            ref={(el) =>
              (fileRefs.current[
                `placements_higher_studies_entrepreneurship_${key}`
              ] = el)
            }
            onChange={(e) =>
              handleFileChange(
