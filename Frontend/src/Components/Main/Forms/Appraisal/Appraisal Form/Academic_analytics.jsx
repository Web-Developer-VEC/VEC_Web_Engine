...
const Academic_analytics = ({ selectedYear, newAcadamicYear, data, setData }) => {
  ...
  return (
    <>
      ...
      <div className="section">
        ...
        <div
          className="form-row grid-4-upload"
          style={{
            fontWeight: "bold",
        ...
        >
          ...
          <div>Commitment Undertakings</div>
          <div>Upload</div>
        </div>
        ...
        <div className="form-row grid-4-upload">
          ...
          <input
            type="text"
            value={
              page1Data.essential_parameters.research_status.present_status ||
              ""
            }
            onChange={(e) =>
              handleInputChange(
                ["essential_parameters", "research_status", "present_status"],
                e.target.value,
              )
            }
          />
          <input
            type="text"
            value={
              page1Data.essential_parameters.research_status.undertaking || ""
            }
            onChange={(e) =>
              handleInputChange(
                ["essential_parameters", "research_status", "undertaking"],
                e.target.value,
              )
            }
          />
          <div style={{ display: "flex", gap: "8px", alignItems: "center" }}>
            <input
              ...
              id="upload-research-status"
              style={{ display: "none" }}
              onChange={(e) =>
                handleFileChange(
                  ["essential_parameters", "research_status", "pdf_path"],
                  e.target.files[0],
                )
              }
            />
            ...
            <label htmlFor="upload-research-status" className="upload-btn">
              {page1Data.essential_parameters.research_status.pdf_path
                ? "Update"
                : "Upload"}
            </label>
        ...
        <div className="form-row grid-4-upload">
          ...
          <input
            ...
            onChange={(e) =>
              handleInputChange(
                ["essential_parameters", "nba_status", "present_status"],
                e.target.value,
              )
            }
          />
          <input
            ...
            onChange={(e) =>
              handleInputChange(
                ["essential_parameters", "nba_status", "undertaking"],
                e.target.value,
              )
            }
          />
          <div >
            <input
              type="file"
              accept="application/pdf"
              id="upload-nba-status"
              style={{ display: "none" }}
              onChange={(e) =>
                handleFileChange(
                  ["essential_parameters", "nba_status", "pdf_path"],
                  e.target.files[0],
                )
              }
            />
            ...
            {/* Upload / Update Button */}
            <label htmlFor="upload-nba-status" className="upload-btn">
              {page1Data.essential_parameters.nba_status.pdf_path
                ? "Update"
                : "Upload"}
            </label>
      ...
      <div className="section">
        <h3 className="section-title">
          II. DEPARTMENT STUDENT ADMITTED DETAILS
        </h3>
        ...
        <div className="form-row">
          ...
          <input
            type="text"
            value={
              page1Data.student_admitted_details.sanctioned_strength
                .sanctioned_value
            }
            onChange={(e) =>
              handleInputChange(
          ...
          <input
            type="text"
            value={
              page1Data.student_admitted_details.sanctioned_strength.undertaking
            }
            onChange={(e) =>
              handleInputChange(
                [
        ...
        <div className="form-row">
          ...
          <input
            type="text"
            value={
              page1Data.student_admitted_details.students_on_roll
                .students_on_roll_value
            }
            onChange={(e) =>
              handleInputChange(
          ...
          <input
            type="text"
            value={
              page1Data.student_admitted_details.students_on_roll.undertaking
            }
            onChange={(e) =>
              handleInputChange(
                ["student_admitted_details", "students_on_roll", "undertaking"],
                e.target.value,
              )
            }
          />
        ...
        <div className="form-row">
          ...
          <input
            type="text"
            value={
              page1Data.student_admitted_details.vacant_seats.vacant_seats_value
            }
            onChange={(e) =>
              handleInputChange(
                [
          ...
          <input
            ...
            onChange={(e) =>
              handleInputChange(
                ["student_admitted_details", "vacant_seats", "undertaking"],
                e.target.value,
              )
            }
          />
      ...
      <div className="section">
        <h3 className="section-title">
          III. END SEMESTER EXAM RESULTS ANALYSIS
        </h3>
        <br />
        <div className="section-group-header grid-z">
          <div></div>
          <div className="group-title" style={{ gridColumn: "2 / 6" }}>
            Odd Sem AY {selectedYear}
          </div>
          <div className="group-title" style={{ gridColumn: "6 / 10" }}>
            Even Sem AY {selectedYear}
          </div>
        </div>
        ...
        {["student_appeared", "student_passed", "pass_percent"].map((key) => (
          <div key={key} className="form-grid grid-z form-input">
            ...
            {[...Array(8)].map((_, i) => {
              ...
              return (
                <input
                  ...
                  onChange={(e) =>
                    handleInputChange(
                      ["end_sem_results", key, sem, yearKey],
                      e.target.value,
                    )
                  }
                />
            ...
            <input
              ...
              onChange={(e) =>
                handleInputChange(
                  ["end_sem_results", key, "undertaking"],
                  e.target.value,
                )
              }
            />
            <div style={{ display: "flex", gap: "8px", alignItems: "center" }}>
              <input
                type="file"
                accept="application/pdf"
                id={`upload-endsem-${key}`}
                style={{ display: "none" }}
                onChange={(e) =>
                  handleFileChange(
                    ["end_sem_results", key, "pdf_path"],
                    e.target.files[0],
                  )
                }
              />
              ...
              {/* Upload / Update Button */}
              <label htmlFor={`upload-endsem-${key}`} className="upload-btn">
                {page1Data.end_sem_results[key].pdf_path ? "Update" : "Upload"}
              </label>

              {/* Eye Icon */}
              {page1Data.end_sem_results[key].pdf_path && (
                <FaEye
                  style={{ cursor: "pointer", fontSize: "18px" }}
                  onClick={() => {
                    const file = page1Data.end_sem_results[key].pdf_path;
                    const fileURL = URL.createObjectURL(file);
                    window.open(fileURL, "_blank");
                  }}
                />
        ...
        {[
          ...
          <div key={key} className="form-grid grid-4 form-input">
            ...
            <input
              ...
              onChange={(e) =>
                handleInputChange(
                  ["graduation_success_rate", key, selectedYear],
                  e.target.value,
                )
              }
            />
            <input
              ...
              onChange={(e) =>
                handleInputChange(
                  ["graduation_success_rate", key, "undertaking"],
                  e.target.value,
                )
              }
            />
            <div style={{ display: "flex", gap: "8px", alignItems: "center" }}>
              <input
                ...
                onChange={(e) =>
                  handleFileChange(
                    ["graduation_success_rate", key, "pdf_path"],
                    e.target.files[0],
                  )
                }
              />
              ...
              <label htmlFor={`upload-${key}`} className="upload-btn">
                {page1Data.graduation_success_rate[key].pdf_path
                  ? "Update"
                  : "Upload"}
              </label>
      ...
      <div className="section">
        ...
        <div
          className="form-grid grid-6-upload"
          style={{
            fontWeight: "bold",
            borderBottom: "2px solid black",
            paddingBottom: "8px",
        ...
        {[
          ...
          <div key={key} className="form-grid grid-6-upload form-input">
            <label className="form-label">
              {idx + 1}. {key.replace("_", " ").toUpperCase()}
            </label>
            ...
            <input
              ...
              onChange={(e) =>
                handleInputChange(
                  ["faculty_learning", key, "undertaking"],
                  e.target.value,
                )
              }
            />
            <div style={{ display: "flex", gap: "8px", alignItems: "center" }}>
              <input
                type="file"
                accept="application/pdf"
                id={`upload-faculty-${key}`}
                style={{ display: "none" }}
                onChange={(e) =>
                  handleFileChange(
                    ["faculty_learning", key, "pdf_path"],
                    e.target.files[0],
                  )
                }
              />
              ...
              {/* Upload / Update Button */}
              <label htmlFor={`upload-faculty-${key}`} className="upload-btn">
                {page1Data.faculty_learning[key].pdf_path ? "Update" : "Upload"}
              </label>

              {/* Eye Icon */}
              {page1Data.faculty_learning[key].pdf_path && (
                <FaEye
                  style={{ cursor: "pointer", fontSize: "18px" }}
                  onClick={() => {
                    const file = page1Data.faculty_learning[key].pdf_path;
                    const fileURL = URL.createObjectURL(file);
                    window.open(fileURL, "_blank");
                  }}
                />
...
export default Academic_analytics;
