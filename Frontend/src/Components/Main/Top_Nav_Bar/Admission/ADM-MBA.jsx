        ...
        <div className="mba-page">
          ...
          <div className="mba-container bg-[#fffae6] dark:bg-drkb border-l-4 border-secd dark:border-drks">
            ...
            <div>
              ...
              <p className="text-text dark:text-drkt ml-8">
                MBA : Apply through Common Entrance Test (CET) conducted by the
            ...
            <div className="mba-content">
              <center>
                <h4 className="text-accn dark:text-drkt font-bold">
                  MBA - Total Intake ({mbaData?.year})
                </h4>
              </center>
              <table className="mba-intake-table">
                ...
                <tbody>
                  <tr className="even:bg-[color-mix(in_srgb,theme(colors.secd),transparent_70%)] dark:even:bg-[color-mix(in_srgb,theme(colors.drks),transparent_70%)] bg-prim dark:bg-drkp">
                    <td className="text-start">
                      Master of Business Administration (MBA)
                    </td>
                    <td className="font-light">
                      {mba["Government Quota Intakes"]}
                    </td>
                    <td className="font-light">
                      {mba["Management Quota Intakes"]}
                    </td>
