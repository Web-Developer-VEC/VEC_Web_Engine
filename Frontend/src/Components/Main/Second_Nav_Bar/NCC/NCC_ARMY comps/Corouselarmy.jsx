...
const CarouselArmy = () => {
  ...
  return (
    <div className="carouselarmy-container">
      ...
      >
        {carouselItems.map((item, index) => (
          <SwiperSlide key={index}>
            <div className="carouselarmy-card">
              <img
                src={item.image}
                alt={item.title}
                className="carouselarmy-image"
              />
              <div className="carouselarmy-content">
                <h3>{item.title}</h3>
                <p className="carouselarmy-location">{item.location}</p>
                <span className="carouselarmy-date">{item.date}</span>
              </div>
            </div>
          </SwiperSlide>
        ))}
