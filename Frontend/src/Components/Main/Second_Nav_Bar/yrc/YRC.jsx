...
const YRC = ({toggle,theme}) => {
  ...
  const navData = {
    ...
    "Awards & Recognition": <Awardsyrc data={yrcData} />
  };
  ...
  const CarouselYRC = ({ data }) => {
    ...
    return (
      <>
        {data ? (
          <div className="yrc-carousel-wrap">
            <div
              className="yrc-carousel-container"
              style={{
              ...
              {data?.map((image, index) => (
                <div className="yrc-carousel-slide" key={index}>
                  ...
                  <img
                    ...
                    alt={image?.title}
                    className="yrc-carousel-image"
                  />

                  {/* Text Below Image */}
                        <div className="yrc-carousel-content">
                        <div className="yrc-carousel-content-left">
                        <h3>{image?.title}</h3>
                        <p>{image?.description}</p>
                        </div>
                        <div className="yrc-carousel-content-right">
                        {image?.date}
                      </div>
                    </div>
                </div>
            ...
            {/* Navigation Buttons */}
            <button
              className="yrc-carousel-btn yrc-carousel-btn-left"
              onClick={prevSlide}
            >
              &#10094;
            </button>
            <button
              className="yrc-carousel-btn yrc-carousel-btn-right"
              onClick={nextSlide}
            >
              &#10095;
            </button>
