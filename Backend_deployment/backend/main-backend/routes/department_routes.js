...
const { getVisionMission, getHODDetails, getStaffDetails, getSyllabus, getInfrastructure, getDeptActivities, getStuActivities, getMou, getNewsLetters, getDepartmentResearch, getsidebar } = require('../controllers/department_controllers');
